  ...
  (function() {
    ...
    return jQuery(function($) {
      ...
      $('#seti').dblclick(function() {
        ...
        $('#feni').addClass("order-3");
        $('#tise').addClass("order-4");
        $('#seti').addClass("order-1");
        $('#nife').addClass("order-2");
...
(function() {
  jQuery(function() {
    return $("#celebrity_character_ids").select2({
...
(function() {
  jQuery(function() {
    ...
    return $("#character_celebrity_ids").select2({
...
(function() {
  jQuery(function() {
    return $("#universe_character_ids").select2({
      placeholder: "Select Universe",
      allowClear: true,
      tokenSeparators: [",", " "]
    });
